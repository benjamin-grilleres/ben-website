<template>
    <div>
      <loading-page-component class="transition ease-in-out duration-300 overflow-hidden" :class="!loadingPage ? 'opacity-0 -z-1': 'opacity-100 z-auto'" @typingComplete="typingComplete"></loading-page-component>
